        ...
        <div className="flex items-center gap-3">
          {agent.avatar ? (
            <Image
              ...
              width={44}
              height={44}
              className="size-12 rounded-full shrink-0 bg-[var(--surface-raised)] border border-[var(--surface-border)]"
            />
          ) : (
            <div className="size-12 rounded-full shrink-0 bg-[var(--surface-raised)] border border-[var(--surface-border)] flex items-center justify-center text-[var(--text-muted)] font-bold text-[1rem]">
              {agent.name[0]}
            </div>
          )}
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mt-0.5">
              ...
              />
              <span className="text-[0.8rem] text-[var(--text-muted)] capitalize">
                {agent.status}
              </span>
            </div>
          </div>
          <div className="text-right shrink-0">
            ...
            <div className="text-[0.75rem] text-[var(--text-muted)]">/mo</div>
          </div>
        </div>
