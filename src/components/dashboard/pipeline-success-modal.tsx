  ...
  for (const output of outputs) {
    ...
    for (const call of output.response.toolCalls) {
      if (call.tool === "get_vercel_preview_url" && call.result) {
        const r = call.result as { url?: string; found?: boolean };
        if (!r.found) continue;
            ...
            <div className="flex flex-col gap-2.5 w-full">
              {prUrl && (
                ...
                >
                  ...
                  >
                    <svg width={18} height={18} viewBox="0 0 24 24" fill="var(--panel-bg)">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-[0.82rem] font-medium text-[var(--text)]">
                      View Pull Request
                    </div>
              ...
              {vercelUrl && (
                ...
                >
                  ...
                  >
                    <svg width={14} height={14} viewBox="0 0 24 24" fill="var(--panel-bg)">
